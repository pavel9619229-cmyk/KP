...
статус ОБРАБОТАТЬ устанавливается, если выполнено хотя бы одно из условий: Клиент заполнен - НЕТ, Менеджер заполнен - НЕТ, Цена в первой строке товара заполнена - НЕТ
