...
def run(cmd):
    ...
    return out
print('REMOTE_CHECKPOINT='+run("d=/opt/kp-api/checkpoints/pre-print-$(date +%Y%m%d-%H%M%S); mkdir -p \"$d\"; cp -a /opt/kp-api/spaceweb_app.py /opt/kp-api/kp_max_navigation.py /opt/kp-api/kp_max_items.py /opt/kp-api/kp_max_create.py /opt/kp-api/kp_max_documents.py \"$d\"/; test ! -f /opt/kp-api/kp_max_print.py || cp -a /opt/kp-api/kp_max_print.py \"$d\"/; echo \"$d\""))
run("mv /opt/kp-api/spaceweb_app.py.new /opt/kp-api/spaceweb_app.py && mv /opt/kp-api/kp_max_navigation.py.new /opt/kp-api/kp_max_navigation.py && mv /opt/kp-api/kp_max_items.py.new /opt/kp-api/kp_max_items.py && mv /opt/kp-api/kp_max_create.py.new /opt/kp-api/kp_max_create.py && mv /opt/kp-api/kp_max_documents.py.new /opt/kp-api/kp_max_documents.py && mv /opt/kp-api/kp_max_print.py.new /opt/kp-api/kp_max_print.py")
run("chown kpapi:kpapi /opt/kp-api/spaceweb_app.py /opt/kp-api/kp_max_navigation.py /opt/kp-api/kp_max_items.py /opt/kp-api/kp_max_create.py /opt/kp-api/kp_max_documents.py /opt/kp-api/kp_max_print.py && chmod 644 /opt/kp-api/spaceweb_app.py /opt/kp-api/kp_max_navigation.py /opt/kp-api/kp_max_items.py /opt/kp-api/kp_max_create.py /opt/kp-api/kp_max_documents.py /opt/kp-api/kp_max_print.py")
run("/opt/kp-api/.venv/bin/python -c 'import reportlab' >/dev/null 2>&1 || /opt/kp-api/.venv/bin/pip install reportlab==4.2.5")
run("/opt/kp-api/.venv/bin/python -m py_compile /opt/kp-api/spaceweb_app.py /opt/kp-api/kp_max_navigation.py /opt/kp-api/kp_max_items.py /opt/kp-api/kp_max_create.py /opt/kp-api/kp_max_documents.py /opt/kp-api/kp_max_print.py")
